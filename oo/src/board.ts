...
export class Board<T> {
    ...
    canMove(first: Position, second: Position): boolean {
        let canMove = false
        let matches = []
        matches.push(matchLR(first, second, this.width, this.height, this.boardValues))
        matches.push(matchUD(first, second, this.height, this.width, this.boardValues))
        matches.push(match2D(first, second, this.height, this.width, this.boardValues))
        matches.push(match2U(first, second, this.height, this.width, this.boardValues))
        matches.push(match2R(first, second, this.height, this.width, this.boardValues))
        matches.push(match2L(first, second, this.height, this.width, this.boardValues))
