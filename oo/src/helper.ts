...
export function matchLR(first: Position, second: Position, width:number, board:any): boolean {
...
export function matchUD(first: Position, second: Position, height:number, board:any): boolean {
    let firstV = board[first.row][first.col];
    let secondV = board[second.row][second.col];
...
export function match2D(first: Position, second: Position, height:number, board:any): boolean {
    let firstV = board[first.row][first.col];
    let secondV = board[second.row][second.col];
    ...
    else if(first.row + 2 <= height && first.row + 2 >= 0){
...
export function match2U(first: Position, second: Position, height:number, board:any): boolean {
    let firstV = board[first.row][first.col];
    let secondV = board[second.row][second.col];
...
export function match2R(first: Position, second: Position, width:number, board:any): boolean {
    let firstV = board[first.row][first.col];
    let secondV = board[second.row][second.col];

    if(second.col + 1 <= width && second.col + 1 >= 0){
        if(board[second.row][second.col+1] === firstV && board[second.row][second.col+2] === firstV){
            return true;
        }
    }
    else if(first.col + 1 <= width && first.col + 1 >= 0){
...
export function match2L(first: Position, second: Position, width:number, board:any): boolean {
    let firstV = board[first.row][first.col];
    let secondV = board[second.row][second.col];
